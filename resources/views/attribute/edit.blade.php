          ...
          <form action="{{ route('attributes.update', $attribute->id) }}" method="post">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" value="{{ $attribute->name }}" required>
                @error('name')
              ...
              <div class="form-group mb-0">
                ...
                <textarea name="description" class="form-control  @error('description') is-invalid @enderror" value="{{ $attribute->description }}"
                  style="height: 100px">{{ $attribute->description }}</textarea>
                @error('description')
                  <div class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                  </div>
